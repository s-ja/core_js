...
let index = 1
let template = /* html */ `<div class='box0${index}'><i>test test test test test test test test test</i><br>test test test test test test test test test test test test</div>`
